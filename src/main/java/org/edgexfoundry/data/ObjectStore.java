...
public class ObjectStore {
	...
	public void put(Device device, ResourceOperation operation, String value) {
		...
		List<ProtocolObject> objectsList = createObjectsList(operation, device);
		
		String deviceId = device.getId();
		List<Reading> readings = new ArrayList<>();
		
		for (ProtocolObject obj: objectsList) {
	...
	private List<ProtocolObject> createObjectsList(ResourceOperation operation, Device device) {
		Map<String, ProtocolObject> objects = profiles.getObjects().get(device.getName());
		List<ProtocolObject> objectsList = new ArrayList<ProtocolObject>();
		if (operation != null && objects != null) {
			ProtocolObject object = objects.get(operation.getObject());
	...
	private String transformResult(String result, ProtocolObject object, Device device, ResourceOperation operation) {
