...
public class ProtocolHandler {
  ...
  private static final EdgeXLogger logger =
      EdgeXLoggerFactory.getEdgeXLogger(ProtocolHandler.class);
  ...
  private void executeOperations(Device device, String commandName, String arguments,
    ...
    for (ResourceOperation operation: operations) {
      ...
      ProtocolObject object =
          getProtocolObject(objects, objectName, transactionId);
  ...
  private ProtocolObject getProtocolObject(Map<String,
      ProtocolObject> objects, String objectName, String transactionId) {
  ...
  private String parseArguments(String arguments, ResourceOperation operation, Device device,
      ProtocolObject object, Map<String, ProtocolObject> objects) {
